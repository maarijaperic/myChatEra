...
class SongTitleScreen extends StatefulWidget {
  ...
  @override
  State<SongTitleScreen> createState() => _SongTitleScreenState();
}

class _SongTitleScreenState extends State<SongTitleScreen>
  ...
  String get _shareText {
    ...
    return 'My life is basically "$title" by $artist ($year) according to AI. 🎵 Soundtrack of my life! #mychateraAI';
  }
    ...
    return Scaffold(
      body: RepaintBoundary(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            // Light purple/pink gradient background (same as movie title)
            Container(
                    ...
                    _AnimatedFade(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            widget.question ?? 'What song title describes your life?',
                            textAlign: TextAlign.center,
                            style: GoogleFonts.inter(
